...
def main():
    ...
    input_img2 = cv2.resize(input_img2, (90, 90)).reshape((1, 90, 90, 1)).astype(np.float32) / 255
    cv2.imwrite('./database/cvt_'+image_names, input_img1)
    cv2.imwrite('./database/cvt_'+image_names2, input_img2)
    input_data = []
    ...
    if pred_rx > 0.5:
        ...
        #print('WorkingTime: {}sec\n input1 = {}, input2 = {}'.format(time.time()-start_time, input_img1_name, input_img2_name))
